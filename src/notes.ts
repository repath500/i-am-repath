...
export const notes: Note[] = [
  ...
  { mood: 'light', text: 'motivation visits. resolve stays. one is a feeling that comes and goes with the weather, the other is a promise you keep to yourself long after the feeling has left the room. when the mood dies, the standard remains, and that is the part that actually builds a life.' },
  ...
  { mood: 'soft', text: 'i am still becoming. less noise, more truth. less performance, more presence. i would rather be slowly honest than quickly admired, and i am learning the difference between the two.' },
  ...
  { mood: 'heavy', text: 'the version of you that kept going through the worst of it is not a smaller, broken version. it is the truest one you have. do not be ashamed of who you had to become to survive.' },
  ...
  { mood: 'heavy', text: 'life is going to be hard. some seasons will beat the shit out of your plans, your confidence, your patience, your sleep. survive them anyway. keep your name intact, keep your heart working, keep moving ugly if you have to, but keep fucking moving.' },
  { mood: 'heavy', text: 'i am going to win. there is no softer version of it, no backup ending, no quiet excuse waiting for me if it gets hard. i will keep going until the work breaks in my favor because stopping is not an option i respect.' },
  { mood: 'heavy', text: "don't forget who you are. not the version shaped by fear, not the one that shrinks to fit other people's limits. remember your name, your nerve, your reason. walk like your life still belongs to you." },
