  ...
  return (
    <section className="note-row mt-16 border-t border-white/10 pt-12 md:mt-20 md:pt-16">
      ...
      <a
        ...
        className="mt-8 inline-flex items-center gap-2 border-b border-white/25 pb-1 font-stoke text-[clamp(1rem,3vw,1.15rem)] lowercase text-stone-300 transition duration-300 hover:border-white/55 hover:text-stone-100"
      >
